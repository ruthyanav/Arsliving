                                ...
                                <?php
                                    foreach ($orders as $myorder)
                                    {
                                        ...
                                        <div class="card product_data mb-3 ">
                                            <div class="row align-items-center">
                                                    <div class="col-md-3">
                                                        <h5><?= $myorder['tracking_no']; ?></h5>
                                                    </div>

                                                    <div class="col-md-2">
                                                        <h5>Rp <?= number_format($myorder['total_price']); ?></h5>
                                                    </div>

                                                    <div class="col-md-2">
                                                        <h5><?= $myorder['payment_method']; ?></h5>
                                                    </div>

                                                    <div class="col-md-2">
                                                        <h5><?= $myorder['created_at']; ?></h5>
                                                    </div>
                                                    ...
                                                    <div class="col-md-1">
                                                        <a href="order_details.php" class="btn btn-primary">View</a>
                                                    </div>
                    ...
                    <?php
                        ...
                        ?>
                            <div class="card card-body shadow text-center">
                                <h4 class="py-3">You haven't placed any order</h4>
                            </div>
                        <?php
                    }
                    ?>
